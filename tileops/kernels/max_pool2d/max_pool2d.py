"""Max Pooling Forward Kernel using TileLang.
...
@torch.library.custom_op("top::max_pooling_fwd", mutates_args=())
def _max_pooling_fwd_wrapped(
    batch: int,
    in_seq_len: int,
    dim: int,
    out_seq_len: int,
    ...
    return _max_pooling_fwd_kernel(
        batch,
        in_seq_len,
        dim,
        out_seq_len,
...
@_max_pooling_fwd_wrapped.register_fake
def _(
    batch: int,
    in_seq_len: int,
    dim: int,
...
class MaxPoolingFwdKernel(Kernel):
    ...
    def __init__(
        ...
        self.kernel = _max_pooling_fwd_kernel(
            self.batch,
            self.in_seq_len,
            self.dim,
            self.out_seq_len,
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        return _max_pooling_fwd_wrapped(
            self.batch,
            self.in_seq_len,
            self.dim,
            self.out_seq_len,
