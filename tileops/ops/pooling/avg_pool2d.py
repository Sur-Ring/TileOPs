...
from tileops.kernels.pooling import AvgPooling2dKernel

from tileops.ops.op import Op

__all__ = ["AvgPooling2dOp"]


class AvgPooling2dOp(Op):
    """Average Pooling 2D Forward Operator.
    ...
    Example:
        >>> op = AvgPooling2dOp(kernel_size=2, stride=2)
    ...
    def default_kernel_map(self) -> dict[str, type[Kernel]]:
        return {"avg_pooling_2d": AvgPooling2dKernel}
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of average pooling 2D.
        ...
        kernel = self.kernel_map["avg_pooling_2d"](
            batch=batch,
            channels=channels,
            in_h=in_h,
            in_w=in_w,
    ...
    def __repr__(self) -> str:
        return (
            f"AvgPooling2dOp(kernel_size={self.kernel_size}, stride={self.stride}, "
