...
class MaxPooling2dBenchmark(BenchmarkBase):
    ...
    def calculate_flops(self) -> Optional[float]:
        """Calculate FLOPs for max pooling 2D.

        Max pooling performs (kernel_size_h * kernel_size_w - 1) comparisons per output element.
        """
...
def bench_max_pool2d(
    ...
    test_instance.stride = stride
    test_instance.padding = padding
    test_instance.dilation = dilation
    ...
    bm = MaxPooling2dBenchmark(test_instance)
